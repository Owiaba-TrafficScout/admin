...
<template>
    ...
    >
        <!-- SIDEBAR HEADER -->
        <div
            class="py-5.5 lg:py-6.5 flex items-center justify-between gap-2 px-6"
        >
            <router-link to="/">
        ...
        >
            ...
            <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
                <template v-for="menuGroup in menuGroups" :key="menuGroup.name">
                    <div>
                        <h3
                            class="text-bodydark2 mb-4 ml-4 text-sm font-medium"
                        >
                            {{ menuGroup.name }}
                        </h3>
            ...
            <!-- Promo Box -->
            <div
                class="border-strokedark bg-boxdark shadow-default mx-auto mb-10 w-full max-w-60 rounded-sm border px-4 py-6 text-center"
            >
                ...
                <a
                    ...
                    target="_blank"
                    rel="nofollow"
                    class="bg-primary flex items-center justify-center rounded-md p-2 font-medium text-white hover:bg-opacity-90"
                >
                    Purchase Now
                </a>
            </div>
